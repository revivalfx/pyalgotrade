...
class BaseForexTestStrategy(strategy.ForexBacktestingStrategy):
    def __init__(self, barFeed, instrument, cash=1000000):
        strategy.ForexBacktestingStrategy.__init__(self, barFeed, cash)
...
class ForexTestStrategy(BaseForexTestStrategy):
    def __init__(self, barFeed, instrument, cash):
        BaseForexTestStrategy.__init__(self, barFeed, instrument, cash)
    ...
    def onEnterOk(self, position):
        ...
        BaseForexTestStrategy.onEnterOk(self, position)
    ...
    def onEnterCanceled(self, position):
        ...
        BaseForexTestStrategy.onEnterCanceled(self, position)
        self.__activePosition = None
    ...
    def onExitOk(self, position):
        ...
        BaseForexTestStrategy.onExitOk(self, position)
    ...
    def onExitCanceled(self, position):
        ...
        BaseForexTestStrategy.onExitCanceled(self, position)
        assert(position.isOpen())
        assert(len(position.getActiveOrders()) == 0)
        assert(position.getShares() != 0)
...
class ForexBaseTestCase(common.TestCase):
    ...
    def loadIntradayBarFeed(self):
        ...
        barFeed.addBarsFromCSV(ForexBaseTestCase.TestInstrument, common.get_data_file_path("nt-spy-minute-2011.csv"))
        return barFeed

    def loadDailyBarFeed(self):
        barFeed = yahoofeed.Feed()
        barFeed.addBarsFromCSV(ForexBaseTestCase.TestInstrument, common.get_data_file_path("orcl-2000-yahoofinance.csv"))
        return barFeed
    ...
    def createStrategy(self, useIntradayBarFeed=False):
        ...
        strat = ForexTestStrategy(barFeed, ForexBaseTestCase.TestInstrument, 1000)
        return strat
        
###############################################################################

class ForexLongPosTestCase(ForexBaseTestCase):
    def testEnterAndExit(self):
        instrument = "orcl"
        barFeed = load_daily_barfeed(instrument)
        strat = ForexEnterAndExitStrategy(barFeed, instrument)
        strat.run()
    ...
    def testCancelEntry(self):
        instrument = "orcl"
        barFeed = load_daily_barfeed(instrument)
        strat = ForexCancelEntryStrategy(barFeed, instrument)
        strat.run()
    ...
    def testExitEntryNotFilled(self):
        instrument = "orcl"
        barFeed = load_daily_barfeed(instrument)
        strat = ForexExitEntryNotFilledStrategy(barFeed, instrument)
        strat.run()
    ...
    def testDoubleExitFails(self):
        instrument = "orcl"
        barFeed = load_daily_barfeed(instrument)
        strat = ForexDoubleExitStrategy(barFeed, instrument)
        strat.run()
    ...
    def testResubmitExit(self):
        instrument = "orcl"
        barFeed = load_daily_barfeed(instrument)
        strat = ForexResubmitExitStrategy(barFeed, instrument)
        strat.run()
    ...
    def testLongPosition(self):
        ...
        strat.addPosEntry(datetime.datetime(2000, 11, 3), strat.enterLong, ForexBaseTestCase.TestInstrument, 1, False)
    ...
    def testLongPositionAdjClose(self):
        ...
        strat.addPosEntry(datetime.datetime(2000, 1, 18), strat.enterLong, ForexBaseTestCase.TestInstrument, 1, False)
    ...
    def testLongPositionGTC(self):
        ...
        strat.addPosEntry(datetime.datetime(2000, 1, 27), strat.enterLong, ForexBaseTestCase.TestInstrument, 1, True)
    ...
    def testEntryCanceled(self):
        ...
        strat.addPosEntry(datetime.datetime(2000, 1, 27), strat.enterLong, ForexBaseTestCase.TestInstrument, 1, False)
        strat.run()
    ...
    def testUnrealized1(self):
        ...
        strat.addPosEntry(dt.localize(datetime.datetime(2011, 1, 3, 20, 53), pytz.utc), strat.enterLong, ForexBaseTestCase.TestInstrument, 1, True)
        strat.run()
        ...
        entryPrice = 127.21
        lastPrice = strat.getFeed().getCurrentBars()[ForexBaseTestCase.TestInstrument].getClose()
    ...
    def testUnrealized2(self):
        instrument = "orcl"
        barFeed = load_daily_barfeed(instrument)
        strat = ForexTestStrategy(barFeed, instrument, 1000)
    ...
    def testActiveOrdersAndSharesLong(self):
        ...
        class Strategy(strategy.ForexBacktestingStrategy):
    ...
    def testPartialFillGTC1(self):
        ...
        strat = ForexTestStrategy(bf, instrument, 1000)
...
class ForexShortPosTestCase(ForexBaseTestCase):
    ...
    def testShortPosition(self):
        ...
        strat.addPosEntry(datetime.datetime(2000, 11, 3), strat.enterShort, ForexBaseTestCase.TestInstrument, 1, False)
    ...
    def testShortPositionAdjClose(self):
        ...
        strat.addPosEntry(datetime.datetime(2000, 1, 18), strat.enterShort, ForexBaseTestCase.TestInstrument, 1, False)
    ...
    def testShortPositionExitCanceled(self):
        ...
        strat.addPosEntry(datetime.datetime(2000, 11, 28), strat.enterShort, ForexBaseTestCase.TestInstrument, 1, False)
    ...
    def testShortPositionExitCanceledAndReSubmitted(self):
        ...
        strat.addPosEntry(datetime.datetime(2000, 11, 10), strat.enterShort, ForexBaseTestCase.TestInstrument, 1)
    ...
    def testUnrealized(self):
        ...
        strat.addPosEntry(dt.localize(datetime.datetime(2011, 1, 3, 20, 53), pytz.utc), strat.enterShort, ForexBaseTestCase.TestInstrument, 1, True)
        strat.run()
        self.assertEqual(strat.enterOkCalls, 1)
        self.assertEqual(strat.exitOkCalls, 0)
        self.assertEqual(strat.enterCanceledCalls, 0)
...
class ForexLimitPosTestCase(ForexBaseTestCase):
    def testLong(self):
        strat = self.createStrategy()
        ...
        strat.addPosEntry(datetime.datetime(2000, 11, 10), strat.enterLongLimit, ForexBaseTestCase.TestInstrument, 25, 1)
    ...
    def testShort(self):
        ...
        strat.addPosEntry(datetime.datetime(2000, 11, 16), strat.enterShortLimit, ForexBaseTestCase.TestInstrument, 29, 1)
    ...
    def testExitOnEntryNotFilled(self):
        ...
        strat.addPosEntry(datetime.datetime(2000, 11, 10), strat.enterLongLimit, ForexBaseTestCase.TestInstrument, 5, 1, True)
        strat.addPosExitLimit(datetime.datetime(2000, 11, 16), 29)
        strat.run()
    ...
    def testEntryGTCExitNotGTC(self):
        ...
        strat.addPosEntry(datetime.datetime(2000, 11, 10), strat.enterLongLimit, ForexBaseTestCase.TestInstrument, 25, 1, True)
...
class ForexStopPosTestCase(ForexBaseTestCase):
    def testLong(self):
        strat = self.createStrategy()
        ...
        strat.addPosEntry(datetime.datetime(2000, 11, 10), strat.enterLongStop, ForexBaseTestCase.TestInstrument, 25, 1)
    ...
    def testShort(self):
        ...
        strat.addPosEntry(datetime.datetime(2000, 11, 16), strat.enterShortStop, ForexBaseTestCase.TestInstrument, 27, 1)
...
class ForexStopLimitPosTestCase(ForexBaseTestCase):
    def testLong(self):
        strat = self.createStrategy()
        ...
        strat.addPosEntry(datetime.datetime(2000, 11, 10), strat.enterLongStopLimit, ForexBaseTestCase.TestInstrument, 25.5, 24, 1)
    ...
    def testShort(self):
        ...
        strat.addPosEntry(datetime.datetime(2000, 11, 16), strat.enterShortStopLimit, ForexBaseTestCase.TestInstrument, 27, 29, 1)
